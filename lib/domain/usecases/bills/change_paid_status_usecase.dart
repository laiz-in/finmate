...
class UpdatePaidStatusUsecase {
  final BillsRepository repository;

  UpdatePaidStatusUsecase(this.repository);
  ...
  Future<Either<String, String>> call({required String uidOfBill}) async {
    try {
      ...
      await repository.updatePaidStatus(uidOfBill);
      
      // If successful, return a success message
      return Right("Bill has been updated the status");
    } catch (e) {
      // If an error occurs, return the error message
      return Left("Failed to update bill status: $e");
    }
  }
}
